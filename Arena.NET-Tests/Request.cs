...
namespace Arena.NET_Tests
{
    ...
    public class RequestTests
    {
        ...
        {
            var result = JsonConvert.DeserializeObject<WvWMatch>(TestJSON);
        ...
        {
            var result = Request.GetResource<WvWMatch>("2-1");
            Assert.IsNotNull(result);
            result.Maps.ForEach(m => m.Objectives.ForEach(o =>
            {
                Assert.IsNotNull(o);
        ...
        {
            var result = Request.GetResourceList<WvWMatch>();
            Assert.IsNotNull(result);
        ...
        public void World()
        {
            var result = Request.GetResourceList<World>();
            Assert.AreEqual(51, result.Count);
            Request.Lang = "en";
            var sresult = Request.GetResource<World>("1001");
        ...
        public void Map()
        {
            var map = Request.GetResource<Map>("1099");
        ...
        [TestMethod]
        public void WorldsBulk()
        {
            var worlds = Request.GetResourceBulk<World>("all");
            Assert.IsTrue(worlds.Count == 51);
        }

        [TestMethod]
        public void MatchesBulk()
        {
            var matches = Request.GetResourceBulk<WvWMatch>("all");
            Assert.IsTrue(matches != null && matches.Count > 10);
        }
